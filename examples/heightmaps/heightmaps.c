...
int main(int argc, char **argv){
	...
	AMG_Model *tie_fighter = AMG_LoadModel("assets/tie-fighter.obj");
	...
	AMG_Object *hmap = AMG_CreateHeightmap("assets/hmap.png",		// Ruta del mapa de alturas					// Heightmap file path
										   "assets/hmap_tex.png", 	// Textura del mapa (pasa NULL si no tiene)	// Map texture (NULL if it doesn't have one)
	...
	while(!AMG.Exit){
		...
		if(AMG_Button.Down &PSP_CTRL_CROSS) AMG_Screenshot("screenshot.png");
