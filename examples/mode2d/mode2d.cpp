...
int main(int argc, char **argv){
	...
	AMG_Texture *font = AMG_LoadTexture("assets/font.png", AMG_TEX_RAM);		// Cargala en RAM							// Load it in RAM
	...
	AMG_Texture *canvas = AMG_LoadTexture("assets/canvas.png", AMG_TEX_RAM);	// Carga el lienzo en RAM		// Load it in RAM
	...
	AMG_Texture *mouse = AMG_LoadTexture("assets/mouse.png", AMG_TEX_RAM);	// Carga el puntero en RAM		// Load it in RAM
