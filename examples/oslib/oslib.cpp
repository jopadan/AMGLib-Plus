...
int main(int argc, char **argv){
	...
	OSL_FONT *pgfFont = oslLoadFontFile("assets/ltn0.pgf");
    oslIntraFontSetStyle(pgfFont, 0.5f, RGBA(255,255,255,255), RGBA(0,0,0,0), 0, INTRAFONT_ALIGN_LEFT);
    oslSetFont(pgfFont);
	
	// Fondo PNG	// PNG background
	sprintf(text, "assets/bg.png");
