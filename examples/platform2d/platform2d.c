...
// Define los datos a usar	// assets
...
int main(int argc, char **argv){
	...
	mario = AMG_LoadTexture("assets/mario.png", AMG_TEX_RAM);	// Cargamos la textura					// Load it as a texture
	...
	level[0] = AMG_LoadTexture("assets/back.png", AMG_TEX_RAM);
	level[1] = AMG_LoadTexture("assets/hills_0.png", AMG_TEX_RAM);
	level[2] = AMG_LoadTexture("assets/hills_1.png", AMG_TEX_RAM);
	level[3] = AMG_LoadTexture("assets/world_0.png", AMG_TEX_RAM);
	level[4] = AMG_LoadTexture("assets/world_1.png", AMG_TEX_RAM);
	level[5] = AMG_LoadTexture("assets/world_2.png", AMG_TEX_RAM);
	level[6] = AMG_LoadTexture("assets/world_3.png", AMG_TEX_RAM);
	u8 i;
	for(i=0;i<7;i++){
	...
	u8 *colmap = loadCollisionMap("assets/colmap.raw");
	if(colmap == NULL) AMG_Error(AMG_OPEN_FILE, 0, "assets/colmap.raw");
