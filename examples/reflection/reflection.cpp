...
// Module info
AMG_MODULE_INFO("AMG_Reflection", AMG_USERMODE, 1, 1);
...
int main(int argc, char **argv){
	...
	AMG_Texture *font = AMG_LoadTexture("assets/font.png", AMG_TEX_RAM);	// Cargala en VRAM			// Load in VRAM
	...
	AMG_Model *lego = AMG_LoadModel("assets/lego.obj");
