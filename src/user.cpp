...
// Variables de apoyo
static u32 res, frames=0;
static u64 now, prev;
AMG_Button_ AMG_Button;
SceCtrlData pad;
u32 old_buttons=0;
AMG_Time_ AMG_Time;
ScePspDateTime amg_time__;
...
void AMG_UpdateTime(void){
	...
	AMG_Time.Minute = amg_time__.minute;
	AMG_Time.Second = amg_time__.second;
	AMG_Time.Microsecond = amg_time__.microsecond;
